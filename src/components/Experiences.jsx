...
const Experiences = () => (
    <section id="experiences" className={`flex-col gap-10 ${styles.paddingY} relative font-poppins`}>
        ...
        <div className="py-8 lg:py-16 px-4 mx-auto max-w-screen-sm z-50">
            <h2 className={`${styles.heading2Center}`}>What Have I Learned From My Education and Experiences ?</h2>
            <p className={`${styles.paragraphCenter}`}>
                Take a deep dive into my professional experiences, from my early career beginnings to my latest ventures.
                Discover how my journey has equipped me with the skills and insights to tackle new challenges and drive success.
            </p>
        </div>
