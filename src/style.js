const styles = {
  ...
  paragraph: "font-poppins font-normal text-gray-500 sm:text-[24px] text-[19px] leading-[30.8px] text-center md:text-left",
  ...
  paragraphCenter: "mb-10 font-poppins font-normal text-gray-500 sm:text-[24px] text-[19px] leading-[30.8px] text-center",
