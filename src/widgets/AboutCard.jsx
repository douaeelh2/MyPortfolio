...
const AboutCard = ({ title, icon, description }) => {
    return (
        <div className="space-y-2 feedback-card px-7 py-7 gradient-shadow rounded-lg border border-gray-700 shadow-xl">
            <div className={`flex mt-2 p-2 mr-5 mb-2 bg-blue-gradient feature-img rounded-full w-[40px] h-[40px] ${styles.flexCenter}`}>
                    ...
                    <div className="flex-grow">
                        ...
                        <p className={`font-poppins font-normal text-gray-500 sm:text-[19px] text-[15px] leading-[30.8px]`}> {description}</p>
                    </div>
